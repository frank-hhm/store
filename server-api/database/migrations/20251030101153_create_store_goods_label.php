...
class CreateStoreGoodsLabel extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('store_goods_label');
        $table
            ->addColumn(Column::string('label_name')->setLimit(120)->setDefault("")->setComment('标签名'))
